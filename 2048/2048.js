...
matrix[rowIdx][colIdx].firstElementChild = 2;
matrix[rowIdx2][colIdx2].firstElementChild = 2;
...
function moveBlocks(e) {
    ...
    moves++;
    matrixVal = getCurrentMatrixValues();
    prevMatrix = matrixVal;
    ...
    let check = checkMatrixEquality(prevMatrix, matrixVal);
...
function moveRight(row) {
    ...
    for (let i = 2; i >= 0; i--) {
        ...
        val = parseInt(currElement.innerText);
        nextVal = parseInt(nextElement.innerText);
...
function moveLeft(row) {
    ...
    for (let i = 1; i < 4; i++) {
        ...
        val = parseInt(currElement.innerText);
        prevVal = parseInt(prevElement.innerText);
